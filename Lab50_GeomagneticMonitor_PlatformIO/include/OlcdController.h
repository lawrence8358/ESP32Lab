...
class OlcdController  
{
  public: 
    ...
    */
    ...
    /**
    * 顯示地磁監測資訊（含指北針圖形）
    * @param line1 第一行文字（通常是 WiFi/MQTT 狀態）
    * @param magX 磁場 X 軸數據 (uT)
    * @param magY 磁場 Y 軸數據 (uT)
    * @param magZ 磁場 Z 軸數據 (uT)
    * @param degree 方位角（0-360 度）
    */
    void printGeomagneticData(String line1, float magX, float magY, float magZ, float degree);
